...
## Arguments
  ...
  - orientation:
    ...
    The "standard" orientation has the 'multcompTs' pointing towards the
    names of the items or factor levels; with the "reverse" orientation,
    the bases of the "Ts" point away. By default, the names are on the
    left or below unless the mean of the relevant 'fig' range is less
    than 0.5.
  ...
  - lwd:
    ...
    width of line to connect elements of "T" graphics that might not
